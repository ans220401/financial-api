...
def get_stock_roa(ticker: str) -> str:
    """
    Scrapes Finviz to retrieve the Return on Assets (ROA) for the given stock ticker.
    """
    ...
    print(f"ROA not found for ticker: {ticker}")
    return None
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if roa:
            print(f"Return on Assets (ROA) for {ticker} is: {roa}\n")
        else:
            print("Unable to retrieve ROA. Please check the ticker and try again.\n")